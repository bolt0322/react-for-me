    ...
    if(page==="start") {
        return (
            <div className={banana.page}> 
                ...
                <div className={banana.content}>
                    ...
                    <div className={banana.btn} onClick={()=>{setPage('friends')}}>TEST ABOUT MY FRIENDS!</div>
                </div>
            </div>
        )
        ...
        return (
            <div className={banana.page}>
                ...
                <div className={banana.myPgBtn} onClick={()=>{setPage('myTest')}}>나의 테스트 만들기</div>
                <div className={banana.friendsContainer}>
                    <div className={banana.item}>
                        <div className={banana.itemContainer}>"~~~"의 테스트</div>
                    </div>
                    <div className={banana.item}>
                        <div className={banana.itemContainer}>"~~~"의 테스트</div>
                    </div>
            ...
            <div className={banana.page}>
                ...
                <div className={banana.myPgContainer}>
                    <input
                        ...
                        placeholder="입력하기"
                        style={{backgroundColor: '#f0f0f0', fontSize: '5px'}}/>
                </div>
            </div>
        )
